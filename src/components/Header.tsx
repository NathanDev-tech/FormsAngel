      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-3.5">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-6">
          ...
          <div className="flex items-center gap-3.5 w-full lg:w-auto justify-between lg:justify-start">
            <div className="flex items-center gap-3.5">
              ...
              <div className="relative group shrink-0">
                ...
                <div className="absolute -top-1 -right-1 text-amber-400 dark:text-amber-300 drop-shadow">
          ...
          <div className="flex items-center justify-center gap-2 w-full lg:w-auto">
            <nav 
              className="flex items-center justify-between p-1 rounded-2xl bg-slate-100/90 dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/60 shadow-inner w-full sm:w-auto overflow-x-auto" 
